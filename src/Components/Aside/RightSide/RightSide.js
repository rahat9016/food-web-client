...
const RightSide = (props) => {
  ...
  return (
    <div className="px-2 xl:px-4">
      ...
      <div className="h-[52vh] md:h-[55vh] lg:h-[60vh] overflow-y-scroll scrollbar-hide">
        {/* Cart items */}
        <div className="mt-6 overflow-y-scroll h-full scrollbar-hide px-2">
          {cartItems && cartItems.length > 0 ? (
            ...
            <div className="text-center">
              <img
                src={EmptyCart}
                alt=""
                className="block mr-auto ml-auto mt-10 w-44 sm:w-72 "
              />
